        ...
        if ($this->esTest($chat_id)) {
            ...
            if (strtoupper($respuestacorrecta) == strtoupper($message->getText())) {
                ...
                return $data;
                    ...
                    $data['text'] = 'La respuesta correcta es '.$respuestacorrecta .' y el contenido del fichero de estado es: '  .$current. '¡Incorrecto! Inténtalo otra vez ' . $message->getFrom()->getFirstName();
                    return $data;
                }                                    
        } else {
